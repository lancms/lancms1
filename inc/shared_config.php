...
$monthname[1] = _('January');
$monthname[2] = _('February');
$monthname[3] = _('March');
$monthname[4] = _('April');
$monthname[5] = _('May');
$monthname[6] = _('June');
$monthname[7] = _('July');
$monthname[8] = _('August');
$monthname[9] = _('September');
$monthname[10] = _('October');
$monthname[11] = _('November');
$monthname[12] = _('December');
...
$userprefs[9]['displayName'] = _('Cellphone');

$userprefs[10]['type'] = 'text';
$userprefs[10]['name'] = 'EMail';
$userprefs[10]['displayName'] = _('EMail');


## SpecialListings
$listingtype[0]['type'] = 'eventAttendee';
$listingtype[0]['name'] = _('List all attendees on current event');
...
$userpersonalprefs[0]['displayName'] = _('Allow other users to see my mailadress');
